...
<div class="searchBox">
  <form id="searchForm" method="get" action="<?= base_url('/Sabores-Delicias/public/administrador/entorno_editar_cliente') ?>">
...
<script>
  document.getElementById('searchForm').addEventListener('submit', function(e) {
    ...
    if(nit) {
      var url = "<?= base_url('/Sabores-Delicias/public/administrador/entorno_editar_cliente') ?>/" + nit;
